                  ...
                  <div class="table-responsive">
                    <table class="table">
                     ...
                     <?php
                            ...
                            $con = mysqli_connect("localhost", "aldy_log", "M3rapi14!", "aldy_db") or die (mysqli_error());
...
?>
                    ...
                    <td><?php echo $info['kelas_s']; ?></td>
                    <td><?php echo $info['ruang_s']; ?></td>
                    <td><?php echo $info['kelas_d']; ?></td>
                    <td><?php echo $info['ruang_d']; ?></td>
                    <td><?php echo $info['jurusan']; ?></td>
                    <td><?php echo $info['status']; ?></td>
                    <td><a class="btn btn-sm btn-primary" href="qa.php?hal=edit&kd=<?php echo $info['nis'];?>"><i class="fa fa-edit"></i> Bayar</a>
