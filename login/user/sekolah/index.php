                ...
                <div class="card-header card-header-warning card-header-icon">
                  <div class="card-icon">
                   ...
                   <?php
                     ...
                     $result = mysqli_query($db,"SELECT COUNT(DISTINCT nama) AS total FROM pondok;");
                ...
                <div class="card-header card-header-success card-header-icon">
                  <div class="card-icon">
                   ...
                   <?php
                     ...
                     $result = mysqli_query($db,"SELECT COUNT(DISTINCT nama) AS totalname FROM pondok;");
 while($data=mysqli_fetch_array($result))
                    { ?>
                ...
                <div class="card-header card-header-info card-header-icon">
                  <div class="card-icon">
                   ...
                   <?php
                     ...
                     $result = mysqli_query($db,"SELECT COUNT(*) AS new FROM pondok;");
 while($data=mysqli_fetch_array($result))
                    { ?>
