            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Pembayaran T Quran</h4> 
                  <p class="card-category"><?php echo $data ['status']; ?></p>
                </div>
                
               <div class="card-body">
                  <form action="quranpost.php" method="post">
                    <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          <label></label>
                          <div class="form-group">
                            <label class="bmd-label-floating"> PEMBAYARAN TAHFIDZUL QURAN</label>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-2">
                       ...
                       <div class="col-md-2">
                        <div class="form-group">
                          <label class="bmd-label-floating">SERAGAM</label>
                          <input type="text" name="seragam" class="form-control" value="0" >
                        </div>
                      </div>
