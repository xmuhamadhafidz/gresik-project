          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="card">
               ...
               <div class="card-body">
                  <form action="dapost.php" method="post">
                    <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          <label></label>
                          <div class="form-group">
                            <label class="bmd-label-floating"> PEMBAYARAN SPP DAN UJIAN</label>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                          <label class="bmd-label-floating">UJIAN</label>
                          <input type="text" name="ujian" class="form-control" value="0" >
                        </div>
                      </div>
