            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Pembayaran MTs</h4> 
                  <p class="card-category"><?php echo $data ['status']; ?></p>
                </div>
                
               <div class="card-body">
                  <form action="mtspost.php" method="post">
                    <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                          ...
                          <input type="text" name="ma_jan" class="form-control"  value="" >
                        </div>
                      </div>
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                          ...
                          <input type="text" name="ma_feb" class="form-control" value="" >
                        </div>
                      </div>
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                          ...
                          <input type="text" name="ma_mar" class="form-control" value="" >
                        </div>
                      </div>
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                          ...
                          <input type="text" name="ma_apr" class="form-control" value="" >
                        </div>
                      </div>
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                          ...
                          <input type="text" name="ma_mei" class="form-control" value="" >
                        </div>
                      </div>
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                          ...
                          <input type="text" name="ma_jun" class="form-control" value="" >
                        </div>
                      </div>
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                          ...
                          <input type="text" name="ma_jul" class="form-control" value="" >
                        </div>
                      </div>
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                          ...
                          <input type="text" name="ma_agu" class="form-control" value="" >
                        </div>
                      </div>
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                          ...
                          <input type="text" name="ma_sep" class="form-control" value="" >
                        </div>
                      </div>
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                          ...
                          <input type="text" name="ma_okt" class="form-control" value="">
                        </div>
                      </div>
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                          ...
                          <input type="text" name="ma_nov" class="form-control" value="" >
                        </div>
                      </div>
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                          ...
                          <input type="text" name="ma_des" class="form-control" value="" >
                        </div>
                      </div>
